...
import { formatChartYAxis, formatDate } from "@/lib/chart-utils";

interface ChartSectionProps {
  tokenUsageData: { date: string; count: number }[];
  conversationsData: { date: string; count: number }[];
  timeRangeOptions: { value: string; label: string }[];
  chartMetricOptions: { value: string; label: string }[];
}
