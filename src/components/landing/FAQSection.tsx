    ...
    en: [
      {
        ...
        answer: "NLACE AI Studio is a secure platform that allows companies to create and manage custom artificial intelligence agents, without sharing data with third parties or relying on public models."
      },
      {
        question: "What makes NLACE AI Studio different from other AI solutions?",
        answer: "Unlike other solutions, NLACE AI Studio guarantees total privacy and control over data, rapid implementation without friction, and complete flexibility to adapt AI to each company's objectives."
      },
      {
        question: "Is it safe to use NLACE AI Studio?",
        answer: "Yes. The platform is designed to ensure total data privacy, training AI agents with internal information without exposing it to third parties."
      },
      {
        question: "What types of integrations does it offer?",
        answer: "NLACE AI Studio easily integrates with tools like Metricool, HubSpot, CRMs, marketing platforms, and companies' internal systems. It's also compatible with all large language models (LLM) available in the market, which means you're not limited to OpenAI or any specific provider."
      },
      {
        question: "How long does implementation take?",
        answer: "It depends on the complexity of the project, but in most cases, implementation is quick and frictionless, allowing you to see results in a short time."
      },
      {
        question: "Do I need advanced AI knowledge to use NLACE AI Studio?",
        answer: "No. NLACE AI Studio is designed to be intuitive and easy to use, allowing any company to implement AI without the need for advanced technical knowledge."
      },
      {
        question: "In which sectors can NLACE AI Studio be applied?",
        answer: "NLACE AI Studio is ideal for B2B and B2C companies in technology, marketing, customer service, sales, e-commerce, healthcare, finance, and more."
      },
      {
        question: "How can I access NLACE AI Studio?",
        answer: "We are currently in a closed Alpha phase. You can register on the waiting list to get early access and try it before anyone else."
      },
      {
        question: "What are the costs of NLACE AI Studio?",
        answer: "Costs vary according to the plan and the needs of each company. We have scalable options that adapt to different requirements."
      },
      {
        question: "Do you offer support and guidance?",
        answer: "Yes. Our team of experts will guide you in implementing and optimizing your AI agent to get the best results."
      }
    ]
  };
    ...
    <section className="py-12 md:py-20 bg-[#1D1D1D]">
      <div className="container max-w-4xl mx-auto px-6">
        ...
        <p className="text-[#9E9E9E] text-center mt-8">
          ...
          <a href="https://nlace.com/contacto" target="_blank" rel="noopener noreferrer" className="text-[#9E9E9E] underline hover:text-white transition-colors">
